...
internal fun SteamIdentityInfoCard(
    ...
    val rows = listOf(
        ...
        stringResource(R.string.steam_identity_account_id) to identity.accountId,
        stringResource(R.string.steam_identity_profile_url) to identity.communityProfileUrl
    )
        ...
        Column(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    Text(
                        text = stringResource(R.string.steam_identity_title),
