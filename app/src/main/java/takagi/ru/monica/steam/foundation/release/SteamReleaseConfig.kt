...
/**
 * Public release metadata for the standalone Monica Steam application.
 *
...
object SteamReleaseConfig {
    ...
    const val repositoryName = "Monica-Steam"
    const val repositoryUrl = "https://github.com/JoyinJoester/Monica-Steam"
    const val issuesUrl = "https://github.com/JoyinJoester/Monica-Steam/issues"
    const val releasesUrl = "https://github.com/JoyinJoester/Monica-Steam/releases"
    const val latestReleaseApiUrl =
        "https://api.github.com/repos/JoyinJoester/Monica-Steam/releases/latest"
    const val updateUserAgent = "Monica-Steam"
